/* PrismJS 1.26.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript&plugins=line-highlight+line-numbers+custom-class+keep-markup+unescaped-markup+normalize-whitespace+toolbar+copy-to-clipboard+download-button+match-braces+treeview */
...
"undefined" != typeof Prism && "undefined" != typeof document && document.createRange && (Prism.plugins.KeepMarkup = !0, Prism.hooks.add("before-highlight", function (e) {
    ...
    function r(e) {
        if (function (e) {
                return !o || "span" !== e.nodeName.toLowerCase() || !e.classList.contains("token")
            }(e)) {
            var n = {
                clone: e.cloneNode(!1),
                posOpen: d
